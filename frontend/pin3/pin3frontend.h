...
public:
  ...
  SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
      Pin3Frontend, "ariel", "frontend.pin", SST_ELI_ELEMENT_VERSION(1, 0, 0),
      "Ariel frontend for dynamic tracing using Pin3",
      SST::ArielComponent::ArielFrontend)
  ...
  /* Ariel class */
  Pin3Frontend(ComponentId_t id, Params &params, uint32_t cores, uint32_t qSize,
               uint32_t memPool);
  ~Pin3Frontend();
